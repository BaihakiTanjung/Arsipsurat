...
<html>
    ...
    <head>
		...
		<script type="text/javascript" src="js/suratkeluar.js"></script>
  ...
  <form action="/action_page.php">
    ...
    <input type="text" id="txtPerihal" placeholder=".."/></br>
					...
					<div class="panel-grid" >
						...
						<table class="table table-hover table table-bordered table-striped" id="surat_keluar" border=1 style="margin-top: 10px">
